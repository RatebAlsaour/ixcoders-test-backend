    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">{{ __('Good Morning Jason!') }}</h3>
                    ...
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <div class="d-inline-flex align-items-center">
                                ...
                                <span
                                    class="badge bg-primary font-12 text-white font-weight-medium badge-pill ml-2 d-lg-block d-md-none">{{ _('Users') }}</span>
                            </div>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">{{ __('All Users') }}</h6></h6>
                        </div>
